...
logger = get_logger("data_processing.catboost")


class CleanCatBoost(CleanDf):
...
if __name__ == '__main__':
    clean_catboost_df = CleanCatBoost()
    clean_catboost_df.clean()
    print(clean_catboost_df.df.info())